 ...
 * @param <T>
 */
public class SizelessCircularQueueADT<T> {
  ...
  public SizelessCircularQueueADT(int size) {
    if (size < 1) {
...
/**
 * This class tests the SizelessCircularQueueADT class
 */
class Tester {
  ...
  private static boolean testConstructor() {
    ...
    {
      try {
        SizelessCircularQueueADT<Integer> queue = new SizelessCircularQueueADT<>(0);
    ...
    {
      try {
        SizelessCircularQueueADT<Integer> queue = new SizelessCircularQueueADT<>(1);
      } catch (Exception e) {
  ...
  private static boolean testEnqueue() {
    ...
    {
      SizelessCircularQueueADT<Integer> queue = new SizelessCircularQueueADT<>(2);
      Field arrayField;
      Field frontField;
      Field rearField;
